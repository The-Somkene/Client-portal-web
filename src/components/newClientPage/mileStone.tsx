  ...
  <section className="flex flex-col gap-8">
   ...
   <div className="flex flex-col gap-10 p-10 bg-white rounded-br-xl rounded-bl-xl border-l-5 border-l-[#543CDA]">
        <form className="flex flex-col gap-24">
          ...
          <label htmlFor="" className="textxl font-bold">Milestone  Title</label>
          <input
            type="text"
          ...
          <label htmlFor="" className="textxl font-bold">Milestone Fee</label>
          <input
            type="number"
            placeholder="NGN"
            className="w-full px-4 py-4 bg-[#ecebf1] border-b-4 border-b-[#543CDA] rounded-md focus:outline-none"
          ...
          <label htmlFor="" className="textxl font-bold">Milestone Status (e.g Not Started, In Progress, Completed. On Hold)</label>
          <input
            type="text"
            placeholder="Status"
            className="w-full px-4 py-4 bg-[#ecebf1] border-b-4 border-b-[#543CDA] rounded-md focus:outline-none"
         ...
         <label htmlFor="" className="textxl font-bold">Brief Description</label>
