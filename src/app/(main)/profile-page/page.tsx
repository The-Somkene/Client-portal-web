    ...
    <section className="mt-6">
      ...
      <div className="bg-white mt-5.5 px-10 py-8 rounded-[10px] border-l-10 border-l-[#543CDA] flex gap-9">
        ...
        <div className="text-black">
          <h3 className="text-2xl font-bold">Toluwani Ayomide</h3>
      ...
      <div className="cards grid grid-cols-4 gap-1.5 mt-5.5">
        <div className="card1 bg-white px-7.5 py-6 rounded-[10px] border-l-6 border-l-[#543CDA]">
          <h3 className="font-medium text-[#543CDA] text-sm">
            Food Delivery Website
          </h3>
          <p className="font-medium text-[12px] text-black">Project Manager</p>
          <h3 className="font-medium text-sm text-black pt-3.5 pb-2.5">
            Status:<span className="text-[#00D073]"> Active</span>
          </h3>
          <p className="font-medium text-[12px] text-black">
            Date: May 1, 2025 - Aug 25, 2025
          </p>
        </div>
        <div className="card1 bg-white px-7.5 py-6 rounded-[10px] border-l-6 border-l-[#543CDA]">
          <h3 className="font-medium text-[#543CDA] text-sm">
        ...
        <div className="card1 bg-white px-7.5 py-6 rounded-[10px] border-l-6 border-l-[#543CDA]">
          ...
          <p className="font-medium text-[12px] text-black">Project Manager</p>
          <h3 className="font-medium text-sm text-black pt-3.5 pb-2.5">
            Status:<span className="text-[#8E8E8E]"> Completed</span>
          </h3>
          <p className="font-medium text-[12px] text-black">
            Date: May 1, 2025 - Aug 25, 2025
          </p>
