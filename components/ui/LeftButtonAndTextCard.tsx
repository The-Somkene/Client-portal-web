...
const LeftButtonAndTextCard = ({h1, button}:LeftButtonAndTextCardProps)=>(
    <div className="flex items-center gap-8 min-w-[400px]">
        ...
        {button && <button className="cursor-pointer bg-[#5a3ee6] hover:bg-[#6d52e1] transition-colors text-white px-7 py-2.5 rounded-[8px] font-semibold text-[15px] shadow-none min-w-[180px] h-[40px] flex items-center justify-center" aria-label="Create new deliverable">{button}</button>}
    </div>
)
